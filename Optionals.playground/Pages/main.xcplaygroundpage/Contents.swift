 ...
 */
petName = "Oscar 🐱"
//petName will always be a string optional
 ...
 */
print(petName)
//The console will print out "Optional("Oscar 🐱")"
 ...
 */
if let newPet = anotherPetName {
    print(newPet)
} else {
    print("anotherPetName has no value")
}

//The console will print out "anotherPetName has no value"
 ...
 */
let someoneCool: String?

someoneCool = "You 😉"
print(someoneCool)

//It will print out "Optional("You 😉")"
