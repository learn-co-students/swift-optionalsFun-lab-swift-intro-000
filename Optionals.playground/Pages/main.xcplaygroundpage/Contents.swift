 ...
 */
petName = "Michaelangelo"
// Optional String
/*: question5
 ### 5. Print out `petName` using Swift's `print()` function. What do you expect to see in the console?
 */
print(petName)
// Optional("Michaelangelo")
/*: question6
...
employment = "Blackjack Dealer"

print(employment)

// You can assign the optional constant a value because it wasn't given an initial value
/*: question11
...
// Can't assign new value to optional constant if it is given the initial value of nil.
