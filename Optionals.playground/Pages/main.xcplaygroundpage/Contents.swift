...
/*: question5
 ### 5. Print out `petName` using Swift's `print()` function. What do you expect to see in the console? - Optional ("Reggie")
 */
print(petName)
...
/*: question11
 ### 11. Declare another _constant_ optional string, and set it to `nil` immediately. Then, on the next line, assign a string value to it. What happens?
     - favPetName is a constant's whose value can not be changed.
 */
let favPetName: String? = nil
//favPetName = "Reggie"
