 ...
 */
// write your code here
//anotherPetName = "Chlamydia"
if let anotherPetName = anotherPetName {
    print("Your other pet's name is \(anotherPetName)")
} else {
 ...
 */
// write your code here
let aFourthPetName : String? = nil
aFourthPetName = "Sonic"
print(aFourthPetName)
