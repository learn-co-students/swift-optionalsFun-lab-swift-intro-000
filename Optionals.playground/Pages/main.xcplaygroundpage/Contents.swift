...
// It is String but "optional" string.
...
// Even it has been assigned to a value, it is still an optional String.
...
if let anotherPetName = anotherPetName {
    print("Unwrapped value of anotherPetName \(anotherPetName)")
}else{
